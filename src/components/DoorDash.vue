     ...
     <div v-if="isMobile">
      ...
      <section  :style="{   paddingLeft: isMobile ? '12px' : '0',  paddingRight: isMobile ? '12px' : '0', }">
        ...
        paddingRight : isMobile ? '' : '12%',paddingTop:isMobile ? '5vh' : '5%'}">
          <h1 class="heading"  style="font-family:Suisse !important;font-weight:400;" :style="{fontSize : isMobile ? '42px' : '84px'}"> DoorDash</h1>
         <br v-if="isMobile"/>
...
export default {
   ...
   setup() {
   useHead({
     title: 'About DoorDash',
     meta: [{ name: 'description', content: 'DoorDash' },
